  ...
  return (
    <>
      <section class="text-tertiary body-font">
        <div class="container px-5 pb-24 mt-24 lg:mt-14 flex flex-wrap">
          ...
          <div class="lg:w-1/2 sm:w-1/3 w-full rounded-lg mt-12 lg:ml-12 sm:ml-0 sm:mt-0">
            <img
          ...
          <div class="font-hind rounded-lg flex flex-wrap p-4 mt-12 lg:mt-24 -mx-6  mb-auto lg:w-1/2 sm:w-2/3 content-start">
            ...
            <div class="p-4 sm:w-1/2 lg:w-1/4 w-1/2">
              <h2 class="title-font font-medium text-3xl text-footer">6.5K</h2>
              <p class="leading-relaxed text-tertiary font-semibold text-lg">
                Ratings
              </p>
            </div>
            <div class="p-4 sm:w-1/2 lg:w-1/4 w-1/2">
              <h2 class="title-font font-medium text-3xl text-footer">22K+</h2>
              <p class="leading-relaxed text-tertiary font-semibold text-lg">
                Subscribers
              </p>
            </div>
            <div class="p-4 sm:w-1/2 lg:w-1/4 w-1/2">
              <h2 class="title-font font-medium text-3xl text-footer">
                402K+
              </h2>
              <p class="leading-relaxed text-tertiary font-semibold text-lg">
                Downloads
            ...
            <div class="p-4 sm:w-1/2 lg:w-1/4 w-1/2">
              <h2 class="title-font font-medium text-3xl text-footer">4.5</h2>
              <p class="leading-relaxed text-tertiary font-semibold text-lg">
                Stars
              </p>
            </div>
          ...
          <div class="font-hind rounded-lg flex flex-wrap text-right p-4 -mx-6 mt-12 lg:mt-24 mb-auto lg:w-1/2 sm:w-2/3 content-start sm:pr-10">
            <div class="w-full sm:p-4 px-4 mb-6">
            ...
            <div class="p-4 sm:w-1/2 lg:w-1/4 w-1/2">
              <h2 class="title-font font-medium text-3xl text-footer">200+</h2>
              <p class="leading-relaxed text-tertiary font-semibold text-lg">
                Properties Managed
              </p>
            </div>
            <div class="p-4 sm:w-1/2 lg:w-1/4 w-1/2">
              <h2 class="title-font font-medium text-3xl text-footer">20+</h2>
              <p class="leading-relaxed text-tertiary font-semibold text-lg">
                States Serviced
              </p>
            </div>
            <div class="p-4 sm:w-1/2 lg:w-1/4 w-1/2">
              <h2 class="title-font font-medium text-3xl text-footer">4</h2>
              <p class="leading-relaxed text-tertiary font-semibold text-lg">
                Products & Services
              </p>
            </div>
